    ...
    <section class="feature_section">
      <div class="container">
        <div class="feature_container">
          ...
          <div data-aos="fade-down" class="box active">
            <div class="img-box">
              <i style="font-size: 90px;" class="fa-solid fa-arrow-trend-up"></i>
            </div>
            <h5 class="name">
              Improve
            </h5>
          ...
          <div data-aos="fade-up" class="box">
            <div class="img-box">
              <i style="font-size: 90px;color:#726dae;" class="fa-regular fa-lightbulb"></i>
            </div>
            <h5 class="name">
              Innovate
            </h5>
        ...
        <div class="row">
          <div class="col-lg-5 col-md-6">
            <div class="detail-box"  data-aos="fade-up">
              ...
              <p>
                More than Twenty-Nine years of much diversified experience and direct operations, construction, supply chain and management with National & international experience utilizing extensive engineering and construction operations knowledge.              </p>
              <a href="{{url('/about')}}">
                Read More
              </a>
            </div>
          ...
          <div class="col-lg-7 col-md-6">
            <div data-aos="fade-down" class="img-box">
    ...
    <section class="professional_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div data-aos="fade-down" class="img-box">
              <i class="fa-solid fa-helmet-safety" style="color: #ff8a1d; font-size:300px;"></i>            </div>
          </div>
          <div class="col-md-6 ">
            <div data-aos="fade-up" class="detail-box">
              <h2>
